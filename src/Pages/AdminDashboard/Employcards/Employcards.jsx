import { FaDatabase, FaPlusCircle, FaStar, FaTasks, FaUserCircle } from "react-icons/fa";
import employ from '../../../assets/images/lg/avatar3.jpg'
          ...
          <div className="col-md-12">
            <div className="card border-0 mb-4 no-bg">
              <div className="card-header py-3 px-0 d-sm-flex align-items-center  justify-content-between border-bottom">
                ...
                <button
                  type="button"
                  className="btn light-info-bg me-1 mt-1 w-sm-100"
                  data-bs-toggle="modal"
                  data-bs-target="#createemp"
                >
                  <FaPlusCircle className="icofont-plus-circle me-2 fs-6"></FaPlusCircle>Add Employee
                </button>
                <div className="dropdown">
                  <button
                    className="btn light-info-bg dropdown-toggle mt-1  w-sm-100"
                    type="button"
            ...
            <div className="card teacher-card">
              <div className="card-body d-flex">
                <div className="profile-av pe-xl-4 pe-md-2 pe-sm-4 pe-4 text-center w220">
                  ...
                  <div className="about-info d-flex align-items-center mt-3 justify-content-center">
                    <div className="followers me-2">
                      <FaTasks className="icofont-tasks color-careys-pink fs-4"></FaTasks>
                      <span className="">04</span>
                    </div>
                    <div className="star me-2">
                      <FaStar className="icofont-star text-warning fs-4"></FaStar>
                      <span className="">4.5</span>
                    </div>
                    <div className="own-video">
                      <FaDatabase className="icofont-data color-light-orange fs-4"></FaDatabase>
                      <span className="">04</span>
                    </div>
                  </div>
                </div>
                <div className="teacher-info border-start ps-xl-4 ps-md-3 ps-sm-4 ps-4 w-100">
                  ...
                  <a href="task.html" className="btn btn-dark bg-lavender-purple btn-sm mt-1">
                    <FaPlusCircle className="icofont-plus-circle me-2 fs-6"></FaPlusCircle>Add Task
                  </a>
                  <Link to='/userDashboard'
                    href="employee-profile.html"
                    className="btn btn-dark bg-lavender-purple btn-sm mt-1"
                  >
                    <FaUserCircle className="icofont-invisible me-2 fs-6"></FaUserCircle>Profile
                  </Link>
                </div>
              </div>
            </div>
              ...
              <div className="card-body d-flex">
                ...
                <div className="teacher-info border-start ps-xl-4 ps-md-3 ps-sm-4 ps-4 w-100">
                  ...
                  <a href="task.html" className="btn btn-dark btn-sm mt-1">
                    <i className="icofont-plus-circle me-2 fs-6"></i>First Task
                  </a>
                  <a
                    href="employee-profile.html"
